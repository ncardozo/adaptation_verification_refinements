...
operations to update the CRDT state is commutative. A CRDT is defined as a Typeclass containing 
the type definitions of the operation and the proof obligation of its commutativity~\cite{kuper22}.
