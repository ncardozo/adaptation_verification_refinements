...
specify all steps in the flow of the \ac{COP} program.
...
Refinement Types use \ac{SMT} solvers to validate the verification constraints, and model checkers 
use SAT solvers to check the satisfiability of a propositional formula that represents the program 
